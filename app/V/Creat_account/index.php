<?php require_once __DIR__ . '/Backend.php'; ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="w-75 w-md-50 d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="inputs-div">
                    ...
                    <div class="inputArea mb-2-5 fld d-none" id="email-input">
                        <input placeholder=" " type="text" name="email-input" autocomplete="off">
                        <label for="email-input">Email</label>
                    </div>

                    <!-- phone input -->
                    <div class="inputArea mb-2-5 fld" id="phone-input">
                        <input placeholder=" " type="number" name="phone-input" autocomplete="off">
